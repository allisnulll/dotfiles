...
hl.bind("SUPER + CTRL + left", hl.dsp.window.resize({ x = "-40", y = "0" }))
hl.bind("SUPER + CTRL + right", hl.dsp.window.resize({ x = "40", y = "0" }))
hl.bind("SUPER + CTRL + up", hl.dsp.window.resize({ x = "0", y = "-40" }))
hl.bind("SUPER + CTRL + down", hl.dsp.window.resize({ x = "0", y = "40" }))
...
hl.bind("SUPER + CTRL + Y", hl.dsp.window.resize({ x = "-40", y = "0" }))
hl.bind("SUPER + CTRL + E", hl.dsp.window.resize({ x = "40", y = "0" }))
hl.bind("SUPER + CTRL + A", hl.dsp.window.resize({ x = "0", y = "-40" }))
hl.bind("SUPER + CTRL + H", hl.dsp.window.resize({ x = "0", y = "40" }))
...
-- hl.bind("SUPER + CTRL + H", hl.dsp.window.resize({ x = "-40", y = "0" }))
-- hl.bind("SUPER + CTRL + L", hl.dsp.window.resize({ x = "40", y = "0" }))
-- hl.bind("SUPER + CTRL + K", hl.dsp.window.resize({ x = "0", y = "-40" }))
-- hl.bind("SUPER + CTRL + J", hl.dsp.window.resize({ x = "0", y = "40" }))
